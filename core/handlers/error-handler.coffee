...
class ErrorHandler
  ...
  @createAppError = (msg, params) ->
    (req, res, next) ->
      err = ErrorHandler.createError(msg, params)
      next err
      return

  @displayAppError = (errOverwrite) ->
    (err, req, res, next) ->
  ...
  @displayResErrorFactory = (res, env) ->
    (err) ->
      ErrorHandler.displayError(res, err, env)
      return

  @renderResErrorFactory = (res, env) ->
    (msg, params) ->
      err = ErrorHandler.createError(msg, params)
      ErrorHandler.displayError(res, err, env)
      return
